...
class PostPlan(models.Model):
    ...
    source = models.ForeignKey(Medium, on_delete=models.CASCADE, verbose_name="Где публиковать") # TODO проверить тип и указать, что это - место публикации
    ...
    link = models.CharField(blank=True, null=True, verbose_name="Ссылка на пост", max_length=100)
